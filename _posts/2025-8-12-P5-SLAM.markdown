...
3. The map is published to **WebGUI** as a *user map* viewable in real time.

The result is a continuous map where frequently observed areas appear brighter, and collision zones appear darker.
...
This sequence improves stability and provides fast reactions in confined areas.
